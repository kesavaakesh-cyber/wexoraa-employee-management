  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '1.5rem 1.25rem', borderBottom: '1px solid #f1f5f9' }}>
        ...
        <p style={{ fontSize: '11px', color: '#94a3b8', margin: '6px 0 0', fontWeight: '500', letterSpacing: '0.05em', textTransform: 'uppercase' }}>Admin Panel</p>
      </div>
      ...
      <div style={{ padding: '1rem 1.25rem', borderTop: '1px solid #f1f5f9' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '11px', color: '#94a3b8', margin: 0 }}>Administrator</p>
          </div>
        </div>
